...
fcl.config({
    ...
    "app.detail.icon": "https://batch-token-transfer-tool-dev.vercel.app/favicon.ico"
})
...
const getBalances = async (address: string) => {
    return await fcl.query({
        ...
        args: (arg: any, t: any) => [
            arg('0x4c9135af735b894d', types.Address),
        ],
    })
};
...
const sendFLOW = async (toAddresses: string[], amounts: string[]): Promise<any> => {
    // import FungibleToken from 0xf233dcee88fe0abe
    // import FlowToken from 0x1654653399040a61
    const txCode = `
import FungibleToken from 0x9a0766d93b6608b7
